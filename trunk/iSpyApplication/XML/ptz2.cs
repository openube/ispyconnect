...
public partial class PTZSettings2CameraCommands {
    ...
    private string rightStopField;
    
    private string stopField1;
    ...
    public string LeftStop {
        get {
            return this.leftStopField;
        }
        set {
            this.leftStopField = value;
        }
    }
    ...
    public string RightStop {
        get {
            return this.rightStopField;
        }
        set {
            this.rightStopField = value;
        }
    }
