...
namespace iSpyApplication
{
    ...
    {
        public int Delay = 4;
        public List<GridItem> SelectedIDs;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            SelectedIDs = new List<GridItem>();
            foreach (GridItem li in lbCameras.SelectedItems)
            {
                SelectedIDs.Add(li);
            }
        ...
        private void GridViewCamera_Load(object sender, EventArgs e)
        {
            ...
            {
                var li = (GridItem) lbCameras.Items[j];
    ...
    public struct GridItem
    {
        ...
        public GridItem(string name, int objectid, int typeid)
        {
            _name = name;
            ObjectID = objectid;
            TypeID = typeid;
