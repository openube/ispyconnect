...
namespace iSpyApplication.iSpyWS {
    ...
    public partial class iSpySecure : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback PingAlive4OperationCompleted;
        ...
        /// <remarks/>
        public event PingAlive4CompletedEventHandler PingAlive4Completed;
        ...
        public string Connect2(string username, string password, int port, string identifier, bool tryLoopBack, string version, string computerName, bool bIPv4, string ipAddress, int affiliateID) {
        ...
        /// <remarks/>
        public void Connect2Async(string username, string password, int port, string identifier, bool tryLoopBack, string version, string computerName, bool bIPv4, string ipAddress, int affiliateID) {
            this.Connect2Async(username, password, port, identifier, tryLoopBack, version, computerName, bIPv4, ipAddress, affiliateID, null);
        }
        
        /// <remarks/>
        public void Connect2Async(string username, string password, int port, string identifier, bool tryLoopBack, string version, string computerName, bool bIPv4, string ipAddress, int affiliateID, object userState) {
            ...
            this.InvokeAsync("Connect2", new object[] {
                        ...
                        bIPv4,
                        ipAddress,
                        affiliateID}, this.Connect2OperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://ispyconnect.com/PingAlive4", RequestNamespace="http://ispyconnect.com/", ResponseNamespace="http://ispyconnect.com/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string[] PingAlive4(string username, string password, int port, bool ipv4, string ipexternal, string ipinternal) {
            object[] results = this.Invoke("PingAlive4", new object[] {
                        username,
                        password,
                        port,
                        ipv4,
        ...
        /// <remarks/>
        public void PingAlive4Async(string username, string password, int port, bool ipv4, string ipexternal, string ipinternal) {
            this.PingAlive4Async(username, password, port, ipv4, ipexternal, ipinternal, null);
        }
        
        /// <remarks/>
        public void PingAlive4Async(string username, string password, int port, bool ipv4, string ipexternal, string ipinternal, object userState) {
            if ((this.PingAlive4OperationCompleted == null)) {
                this.PingAlive4OperationCompleted = new System.Threading.SendOrPostCallback(this.OnPingAlive4OperationCompleted);
            }
            this.InvokeAsync("PingAlive4", new object[] {
                        username,
                        password,
                        port,
                        ipv4,
                        ipexternal,
                        ipinternal}, this.PingAlive4OperationCompleted, userState);
        }
        
        private void OnPingAlive4OperationCompleted(object arg) {
            if ((this.PingAlive4Completed != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.PingAlive4Completed(this, new PingAlive4CompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    public delegate void PingAlive4CompletedEventHandler(object sender, PingAlive4CompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class PingAlive4CompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal PingAlive4CompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
